...
#define VARIABLE_IS_NOT_USED
    ...
    static std::string filename_vertex_data(std::string basefilename) {
        std::stringstream ss;
        ss << basefilename;
        ss << "_GraphChi/" << sizeof(VertexDataType) << "B.vout";
        return ss.str();
    }
    
    static std::string filename_degree_data(std::string basefilename)  {
        return basefilename + "_GraphChi/degs.bin";
    }
    ...
    static void delete_shards(std::string base_filename, int nshards) {
        ...
        std::string numv_filename = base_filename + "_GraphChi/N.numvertices";
    ...
    static VARIABLE_IS_NOT_USED size_t get_num_vertices(std::string basefilename) {
        std::string numv_filename = basefilename + "_GraphChi/N.numvertices";
    ...
    std::string preprocess_filename(std::string basefilename) {
        std::stringstream ss;
        ss << basefilename;
        ss << "_GraphChi/" <<  sizeof(EdgeDataType) << "B.bin";
        return ss.str();
    }
