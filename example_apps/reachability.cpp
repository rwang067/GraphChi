...
public:
    ...
    void initializeApp(vid_t _a, vid_t _b){
        a = _a;
        b = _b;
        ans = false;
    }
    ...
    vid_t getOther(vid_t c){
        return a+b-c;  // cannnot a-c+b or b-c+a;
    }
        ...
        if (gcontext.iteration == 0) {
            ...
            for(int i=0; i < vertex.num_inedges(); i++) {
                ...
                for(int j=0; j < invector->size(); j++) {
                    ...
                    if (vertex.get_data() == (vid_t)-1){
                        vertex.set_data(walk);
                    }
                    else if (vertex.get_data() != walk){
                        ans = true;
                    }
...
int main(int argc, const char ** argv) {
    ...
    vid_t a              = get_option_int("a", 1);
    vid_t b              = get_option_int("b", 1000000);
